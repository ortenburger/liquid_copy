...
- [ ] 5. Firecrawl integration and Context_Agent
  ...
  - [ ]* 5.5 Write property tests — `tests/pbt/kb-merge.pbt.test.ts`
...
- [ ] 8. Workflow Engine and operating modes
  - [ ] 8.1 Implement Approval_Checkpoint manager in `src/lib/content-creator-ai/orchestration/checkpoints.ts`
  ...
  - [ ]* 8.2 Write property test for HITL checkpoint invariant — `tests/pbt/workflow-engine.pbt.test.ts`
    - **Property 27: HITL mode always has at least one enabled checkpoint** — Validates: Requirements 12.9, 12.10

  - [ ] 8.3 Implement Workflow Engine state machine in `src/lib/content-creator-ai/orchestration/workflow-engine.ts`
    - FSM states in order:
  ...
  - [ ]* 8.4 Write unit tests for workflow engine
...
- [ ] 9. Traceability layer
  - [ ] 9.1 Implement `TraceabilityChain` builder in `src/lib/content-creator-ai/api/traceability.ts`
  ...
  - [ ]* 9.2 Write property test for traceability — `tests/pbt/traceability.pbt.test.ts`
  ...
  - [ ]* 9.3 Write unit tests for traceability
...
- [ ] 10. REST API and manual knowledge search
  - [ ] 10.1 Implement Next.js API routes in `src/app/api/content-creator-ai/`
  ...
  - [ ] 10.2 Implement SSE endpoint in `src/app/api/content-creator-ai/events/route.ts`
  ...
  - [ ]* 10.3 Write integration tests for API layer — `tests/integration/api.test.ts`
